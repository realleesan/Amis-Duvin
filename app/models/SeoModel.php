...
class SeoModel extends BaseModel
{
    ...
    public function getSeoSettings(): array
    {
        ...
        return [
            'id' => 1,
            'meta_title' => 'Amis Duvin — Không gian Tiệc riêng tư & Tinh hoa ẩm thực Rượu vang',
            'meta_description' => 'Amis Duvin — Không gian Tiệc riêng tư & Tinh hoa ẩm thực Rượu vang tại Hà Nội. Trải nghiệm Food & Wine Pairing và Workshop rượu vang tinh tế.',
            'meta_keywords' => 'Amis Duvin, Rượu vang Hà Nội, Tiệc riêng tư, Food and Wine Pairing, Sommelier Alex Thịnh, Workshop rượu vang',
