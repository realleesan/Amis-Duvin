...
<div id="successModal" class="modal-overlay">
  <div class="relative w-full max-w-md bg-card border border-border rounded-sm shadow-2xl p-7 sm:p-9 text-center animate-scale-in my-auto">
    <button onclick="closeSuccessModal()" type="button" class="absolute top-4 right-4 w-9 h-9 flex items-center justify-center text-muted-foreground hover:text-foreground rounded-full hover:bg-muted transition-colors" aria-label="Đóng">
