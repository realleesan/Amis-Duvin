    ...
    <form id="workshopModalForm" class="flex-1 overflow-y-auto no-scrollbar p-6 sm:p-8" onsubmit="handleWorkshopModalSubmit(event)">
      ...
      <div class="mb-4">
        ...
        <div class="relative">
          ...
          <input type="text" name="full_name" required placeholder="Nguyễn Văn An" class="input-elegant w-full bg-transparent pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="name">
        </div>
      </div>
      ...
      <div class="grid sm:grid-cols-2 gap-4">
        <div class="mb-4">
          ...
          <div class="relative">
            ...
            <input type="tel" name="phone" required inputmode="numeric" placeholder="0912345678" maxlength="10" class="input-elegant w-full bg-transparent pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="tel">
          </div>
        </div>
        ...
        <div class="mb-4">
          ...
          <div class="relative">
            ...
            <input type="email" name="email" required placeholder="an@email.com" class="input-elegant w-full bg-transparent pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="email">
          </div>
        </div>
      </div>
