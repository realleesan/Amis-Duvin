...
<div id="privacyPolicyModal" class="modal-overlay">
  <div class="relative w-full max-w-2xl max-h-[90vh] flex flex-col bg-card border border-border rounded-sm shadow-2xl animate-scale-in my-auto">
    ...
    <div class="p-6 sm:p-8 overflow-y-auto no-scrollbar space-y-4 text-sm text-muted-foreground leading-relaxed">
      <p class="text-foreground font-medium">Amis du Vin cam kết bảo mật tuyệt đối mọi thông tin cá nhân của Quý khách theo các quy định dưới đây:</p>
      <div class="space-y-4">
        <div>
        ...
        <div>
          ...
          <p>Thông tin của Quý khách được lưu trữ an toàn trong hệ thống dữ liệu mã hóa của Amis du Vin và không bao giờ chia sẻ hay bán cho bất kỳ bên thứ ba nào vì mục đích thương mại.</p>
        </div>
