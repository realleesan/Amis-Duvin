...
<div id="welcomeModal" class="modal-overlay">
  <div class="relative w-full max-w-lg text-center animate-scale-in bg-card border border-border rounded-sm overflow-hidden shadow-[0_30px_70px_-20px_rgba(0,0,0,0.8)] my-auto group">
    ...
    <div class="absolute inset-0 z-0">
      <img src="https://media.base44.com/images/public/6a623336361c483b3f15558c/1d3f75363_generated_b7d85214.png/v1/fill/w_1171,h_927,al_c,q_90,usm_0.66_1.00_0.01,enc_webp,quality_auto/1d3f75363_generated_b7d85214.webp" alt="Amis Duvin Ambient" class="w-full h-full object-cover opacity-25">
    ...
    <div class="relative z-10 p-8 sm:p-12">
      ...
      <div class="flex justify-center mb-6">
        <img src="https://media.base44.com/images/public/6a623336361c483b3f15558c/de2b27acb_LogoAmisDuVin.png" alt="Amis Duvin" class="h-16 sm:h-20 w-auto object-contain rounded-sm drop-shadow-md">
      </div>

      <p class="text-[10px] uppercase tracking-[0.4em] text-[var(--gold)] mb-3">— WELCOME TO AMIS DUVIN —</p>
