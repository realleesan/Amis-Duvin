<header id="mainHeader" class="fixed top-0 inset-x-0 z-50 transition-all duration-500 bg-transparent py-5">
  <div class="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
    <button class="flex items-center group transition-transform duration-300 hover:scale-[1.03] relative -top-0.5 sm:-top-1" aria-label="Amis Duvin" onclick="scrollToId('hero')">
      <img src="https://media.base44.com/images/public/6a623336361c483b3f15558c/de2b27acb_LogoAmisDuVin.png" alt="Amis Duvin" class="h-12 sm:h-14 w-auto object-contain rounded-sm">
    </button>
