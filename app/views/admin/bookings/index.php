...
<div class="space-y-6">
  ...
  <!-- Bookings Data Table -->
  <div class="rounded-sm border border-border bg-card overflow-hidden shadow-lg">
    <div class="overflow-x-auto">
      <table class="w-full text-left text-sm border-collapse">
        <thead>
          <tr class="bg-muted/40 text-[11px] uppercase tracking-wider text-muted-foreground border-b border-border">
              ...
              <tr class="hover:bg-muted/20 transition-colors">
                ...
                <td class="p-4 font-medium text-foreground">
                  ...
                  <?php if (!empty($b['notes'])): ?>
                    <div class="text-[11px] text-muted-foreground/80 truncate max-w-xs" title="<?= htmlspecialchars($b['notes']) ?>">Ghi chú: <?= htmlspecialchars($b['notes']) ?></div>
                  <?php endif; ?>
                </td>
...
<div id="editBookingModal" class="modal-overlay">
  <div class="relative w-full max-w-lg bg-card border border-border rounded-sm p-6 sm:p-8 shadow-2xl animate-scale-in my-auto">
