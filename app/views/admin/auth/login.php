      ...
      <form action="/admin/login" method="POST" class="space-y-4 text-left pt-2">
        <div>
          ...
          <div class="relative">
            ...
            <input type="text" name="username" required placeholder="admin / cskh / marketing" class="input-elegant w-full pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="username">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input type="password" name="password" required placeholder="••••••••" class="input-elegant w-full pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="current-password">
          </div>
        </div>
