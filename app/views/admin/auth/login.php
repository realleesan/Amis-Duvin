...
<body class="bg-background text-foreground min-h-screen flex items-center justify-center p-5">
  <div class="max-w-md w-full bg-card border border-border rounded-sm p-8 sm:p-10 shadow-2xl space-y-6 relative overflow-hidden">
    ...
    <div class="relative z-10 text-center space-y-4">
      ...
      <p class="text-[10px] uppercase tracking-[0.35em] text-[var(--gold)]">Hệ thống Quản trị CMS</p>
      ...
      <form action="/admin/login" method="POST" class="space-y-4 text-left pt-2">
        <div>
          <label class="block text-xs uppercase tracking-[0.15em] text-foreground/60 mb-2">Tên đăng nhập</label>
          <div class="relative">
            ...
            <input type="text" name="username" required placeholder="admin / cskh / marketing" class="input-elegant w-full bg-background pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="username">
          </div>
        </div>

        <div>
          <label class="block text-xs uppercase tracking-[0.15em] text-foreground/60 mb-2">Mật khẩu</label>
          <div class="relative">
            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground pointer-events-none">
            ...
            <input type="password" name="password" required placeholder="••••••••" class="input-elegant w-full bg-background pl-11 pr-4 py-3.5 rounded-sm text-sm" autocomplete="current-password">
          </div>
        </div>
      ...
      <div class="pt-4 border-t border-border text-[11px] text-muted-foreground">
