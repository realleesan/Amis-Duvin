<section id="sommelier" class="scroll-anchor relative py-24 sm:py-32 bg-background overflow-hidden">
  ...
  <div class="relative max-w-7xl mx-auto px-5 sm:px-8">
    <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      <div class="reveal is-visible">
        <div>
          <p class="text-[var(--gold)] text-xs uppercase tracking-[0.35em] mb-5">Sommelier</p>
          <p class="font-serif-display italic text-lg sm:text-xl text-foreground/60 mb-2">Chuyên gia Rượu vang &amp; Nghệ thuật Ngoại giao</p>
