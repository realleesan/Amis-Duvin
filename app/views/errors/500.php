...
<body class="bg-background text-foreground min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
  ...
  <div class="max-w-lg w-full text-center space-y-6 relative z-10">
    ...
    <div class="pt-4 flex justify-center gap-4">
      <button onclick="window.location.reload()" class="btn-wine inline-flex items-center gap-2 px-6 py-3.5 rounded-sm text-xs uppercase tracking-[0.2em] font-medium shadow-xl">
        <span>Tải lại trang</span>
      </button>

      <a href="/" class="btn-invert inline-flex items-center gap-2 px-6 py-3.5 rounded-sm text-xs uppercase tracking-[0.2em] font-medium">
